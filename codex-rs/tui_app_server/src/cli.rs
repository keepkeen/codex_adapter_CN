...
pub struct Cli {
    ...
    /// Enable live web search. Responses models use the native `web_search` tool; chat-completions providers use the local compatibility adapter (no per-call approval).
